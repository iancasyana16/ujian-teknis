            ...
            <div class="bg-white shadow-xl rounded-xl overflow-hidden">
                <form action="{{ route('users.update', $user->id) }}" method="POST">
                    ...
                    <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Role -->
                        <div class="flex flex-col">
                            <label for="role" class="mb-2 text-gray-700 font-medium">Role</label>
                        ...
                        <div class="flex flex-col md:col-span-2">
                            ...
                            <textarea name="address" id="address" placeholder="Enter address"
                                class="p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm transition duration-200 resize-none h-32">{{ old('address', $user->address) }}</textarea>
                        </div>
