<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-2xl text-gray-900">Edit Finance</h2>
    </x-slot>
            ...
            <form action="{{ route('finances.update', $finance->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col md:col-span-2">
                        ...
                        <input type="number" step="0.01" name="amount" value="{{ old('amount', $finance->amount) }}"
                    ...
                    <div class="flex flex-col md:col-span-2">
                        ...
                        <textarea name="description" placeholder="Enter description"
                            class="p-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:outline-none h-32">{{ old('description', $finance->description) }}</textarea>
                    </div>

                    <!-- Date -->
                    <div class="flex flex-col md:col-span-2">
                        <label class="mb-2 font-medium text-gray-700">Date</label>
                        <input type="date" name="date" value="{{ old('date', $finance->date->format('Y-m-d')) }}"
                            class="p-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:outline-none">
                    </div>
